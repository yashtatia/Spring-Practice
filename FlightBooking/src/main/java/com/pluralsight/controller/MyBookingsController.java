...
import com.pluralsight.model.TicketDetails;
...
public class MyBookingsController {
	...
	public String manageTicket(@RequestParam("bookingId") int bookingId, Model model) {
		UserPaymentDetails user = myBookingsService.findOne(bookingId);
		TicketDetails it = new TicketDetails(user);		
		model.addAttribute("ticketDetails", it);
		return "manageTicket";
	}
	
	@ModelAttribute("logInForm")
	public LogInDetails getLogin() {
		System.out.println("loginform invoked bookings");
