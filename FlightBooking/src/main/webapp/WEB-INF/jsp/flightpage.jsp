		...
		<div class="card" style="background-color: #f2f2f2;" >
			<div class="card-body">
				<form:form modelAttribute="flightSearch" method="POST" >
					...
					<div class="form-row">
						<div class="form-group col-md-5">
							<form:input path="flight_date" id="fdate" class="input-large form-control" type="date" name="flight_date" data-date-inline-picker="true" value="${flightSearch.flight_date}"/>
						</div>
						<div class="col-md-2">
		...
		<div class="row row-content">
			<div class="col-lg-12 " >
				<table class="table table-striped table-hover">
						...
						<tr>
							...
							<td>
								<table style="border: none; padding: none;" >
									<tr>
										<td>${flightReport.departure.airport_id} ${flightReport.departure_time1}</td>
									</tr> 
									<tr>
							...
							<td>${flightReport.duration1}</td>
							<td>
								<table style="border: none; padding-left: 2px:;">
									<tr>
										<td>${flightReport.arrival.airport_id} ${flightReport.arrival_time1}</td>
									</tr> 
									<tr>
					...
					<c:if test="${flightsReport.size() == 0}" >
						<tr>
						<td>
						OOPS! Sorry No Flights are available in your route at the Moment
						<td>
						</tr>
					</c:if>
				</table>
