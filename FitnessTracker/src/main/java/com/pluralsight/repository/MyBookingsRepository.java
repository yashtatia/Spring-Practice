...
public interface MyBookingsRepository extends JpaRepository<UserPaymentDetails, Integer>{
	...
	@Query("Select new com.pluralsight.model.MyBookingsReport(u.flight_id.route_id.source_id, u.flight_id.route_id.destination_id, u.flight_id.carrier_id, u.flight_id.seat_matrix.seat_type.description, u.seats, u.total_amount, u.booking_id, u.flight_id.flight_id, u.flight_id.date, u.booked_on, u.booking_status) " +  
			"from UserPaymentDetails u where u.user_id.email = ?1 order by u.booked_on desc, u.booking_id desc")
